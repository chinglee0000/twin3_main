...
### 3.3 Twin Matrix Quadrant Colors

> **用途**: Twin Matrix 16x16 grid 的四個象限顏色，符合 WCAG AA 對比度標準 (≥4.5:1)

| Quadrant | Dark Mode | Light Mode | 對比度 (vs #0a0a0a) |
|----------|-----------|------------|---------------------|
| **Physical** | `#D02800` (Red) | `#FDE8E5` | 5.0:1 ✅ |
| **Social** | `#FFBA08` (Yellow) | `#FFF8E5` | 10.9:1 ✅ |
| **Digital** | `#3F88C5` (Blue) | `#E8F1F9` | 5.9:1 ✅ |
| **Spiritual** | `#1A9E8F` (Teal) | `#E5F5F3` | 5.2:1 ✅ |
| Undiscovered | `transparent` | `#dedfe3` | — |

```typescript
const twinMatrixColors = {
  physical:  { dark: '#D02800', light: '#FDE8E5' },
  social:    { dark: '#FFBA08', light: '#FFF8E5' },
  digital:   { dark: '#3F88C5', light: '#E8F1F9' },
  spiritual: { dark: '#1A9E8F', light: '#E5F5F3' },
  undiscovered: '#dedfe3',
};
```
